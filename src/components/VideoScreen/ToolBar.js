...
export default class ToolBar extends Component {
  ...
  stopCall = () => {
    ...
    // this.props.props.navigation.navigate('Consultat pionHistory');
    const resetAction = StackActions.reset({
      index: 0,
      actions: [StackActions.reset({routeName: 'ConsultationHistory'})],
    });
